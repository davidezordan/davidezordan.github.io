...
<img class="aligncenter size-large wp-image-8277" src="http://www.davidezordan.net/blog/wp-content/uploads/2018/03/TwoHandsManipulations-04Device-1024x576.jpg" alt="" width="660" height="371" />
...
<img class="aligncenter size-large wp-image-8274" src="http://www.davidezordan.net/blog/wp-content/uploads/2018/03/TwoHandsManipulations-01MarsRover-1024x549.png" alt="" width="660" height="354" />
...
<img class="aligncenter size-large wp-image-8275" src="http://www.davidezordan.net/blog/wp-content/uploads/2018/03/TwoHandsManipulations-02CapsuleCollider-1024x549.png" alt="" width="660" height="354" />
...
<img class="aligncenter size-large wp-image-8276" src="http://www.davidezordan.net/blog/wp-content/uploads/2018/03/TwoHandsManipulations-03TwoHandManipulatableScript-722x1024.png" alt="" width="660" height="936" />

And set the manipulation mode to <strong>Move Rotate Scale</strong>.

The scene was completed, so I only had to test it with the device: I selected the <strong>File-&gt;Build Settings</strong>, generated the package and deployed it to HoloLens, and I got the Mars Rover ready to be explored with two-handed manipulations. Amazing! <img class="aligncenter size-large wp-image-8277" src="http://www.davidezordan.net/blog/wp-content/uploads/2018/03/TwoHandsManipulations-04Device-1024x576.jpg" alt="" width="660" height="371" />

The source code is available on my GitHub playground <strong><a href="https://github.com/davidezordan/MixedRealitySamples/tree/master/Two-hands%20manipulation" target="_blank" rel="noopener">here</a></strong>.